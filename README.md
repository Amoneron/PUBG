...
### CC Opus — Runchip, Ядовитые пули
**Автор:** Claude | **Сила:** 9/10

Ядовитый хищник с 10-фазным деревом решений. Отравляет цели (60 HP за пулю: 10 прямого + 50 ядом), оптимизирует выбор целей по IQ-награде, лечит собственное отравление поеданием пуль. Уклоняется с учётом стен, использует оппортунистические отравленные выстрелы.
...
│   │   ├── opus.ts              # CC Opus — Runchip, ядовитые пули
